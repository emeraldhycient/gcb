    ...
    <>
     ...
     data-aos-duration="1000">
              ...
              <p
                ...
                data-aos-duration="1000"
              >
                Guaranteed Capital Bank is your goto partner for your next movie
     ...
     data-aos-duration="1000">
                ...
                and you would see a button that enables you to request for your
                credit card.
              </h6>
            </div>
            <div className="col-md-4">
     ...
     data-aos-duration="1000">
                ...
                dedicated cryptocurrency wallet address.
              </h6>
            </div>
          </div>
        </div>
      ...
      <section
        className=""
        style={{ marginTop: "230px", marginBottom: "200px" }}
      >
        <center>
     ...
     data-aos-duration="1000">
              <center>
                ...
                <h6 className="mb-4 p text-muted">
                  Our online banking resource provides free & detailed
                  statistics to all Guaranteed Capital Bank user transactions
                  both local and international transactions.
                </h6>
              </center>
            </div>
            <div className="col-md-4"               data-aos="zoom-in"
     ...
     data-aos-duration="1000">
              <center>
                ...
                />
                <h5 className="my-3">
                  CASH BACK UPTO <span className="text-success">20%</span>
                </h5>
                <h6 className="p mb-4 text-muted">
                  Going to the supermarket shop with our credit card , going to
                  the movies pay with our card , planning for your next big
                  travel pay with our card and get cash back on every
                  transactions you do upto 20% in cashback weekly.
                </h6>
              </center>
            </div>
            <div className="col-md-4"               data-aos="zoom-in"
     ...
     data-aos-duration="1000">
              <center>
                ...
                />
                <h5 className="my-3">
                  <span className="text-primary">10</span> FREE INTERNATIONAL
                  TRANSFER
                </h5>
                <h6 className="p mb-4 text-muted">
                  We Have Several Options which enables you to fund or transfer
                  from your account to an international client of yours.we offer
                  upto 10 free transactions on all international money transfer.
                </h6>
              </center>
            </div>
          </div>
     ...
     data-aos-duration="1000">
              ...
              <h2 className="text-white mt-5 text-center">
                <b className="text-primary" style={{ fontFamily: "impact" }}>
                  90%
                </b>{" "}
                of our customers leave postive reviews after banking for the
                first time
              </h2>
            </div>
     ...
     data-aos-duration="1000">
              ...
              <h2 className="text-white mt-5 text-center">
                <b className="text-warning" style={{ fontFamily: "impact" }}>
                  75%
                </b>{" "}
                of the first time customer reviewers continued using our
                servivces.
              </h2>
            </div>
          </div>
     ...
     data-aos-duration="1000">
              ...
              <div className="d-flex justify-content-around">
                <img src={downloadiphone} alt="" id="appstore" />
                <img src={downloadandroid} alt="" id="appstore" />
              </div>
            </div>
          </div>
        </div>
